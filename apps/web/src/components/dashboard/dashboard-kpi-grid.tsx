...
import { Tv, Building2, Activity, HardDrive } from 'lucide-react';
...
export function DashboardKPIGrid() {
  ...
  const statusLabel = 'Operacional';
  const statusDetail = 'Todos os serviços ativos';

  if (loading) {
    return (
      <div className="animate-pulse grid grid-cols-2 laptop:grid-cols-4 gap-3">
        {[...Array(4)].map((_, i) => (
