...
export function DashboardKPIGrid() {
    ...
    const statusLabel =
        stats.screens === 0 ? "Sem Telas" :
        stats.onlineScreens === 0 ? "Offline" :
        offlineScreens > 0 ? "Parcial" :
        "Operacional";

    const statusDetail =
        stats.screens === 0 ? "Cadastre um player" :
        stats.onlineScreens === 0 ? "Nenhuma tela online" :
        offlineScreens > 0 ? `${offlineScreens} offline` :
        "Todas online";

    if (loading) {
        return <div className="animate-pulse grid grid-cols-2 laptop:grid-cols-5 gap-3">
            {[...Array(5)].map((_, i) => (
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-border bg-panel-bg shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all duration-500 p-5 h-28 flex flex-col justify-center">
                ...
                <div className="relative">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-[11px] font-black uppercase tracking-[0.2em] text-text-light/80">Playlists</span>
                    </div>
                    <div className="flex items-baseline gap-3">
                        <div className="text-3xl font-black text-text-dark">{stats.playlists}</div>
                        <div className="text-[10px] font-bold text-text-light/60 uppercase tracking-widest translate-y-[-2px]">Ativas</div>
                    </div>
                </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-border bg-panel-bg shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all duration-500 p-5 h-28 flex flex-col justify-center">
                ...
                <div className="relative">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-[11px] font-black uppercase tracking-[0.2em] text-text-light/80">Telas</span>
                    </div>
                    <div className="flex items-baseline gap-3">
                        <div className="text-3xl font-black text-text-dark">{stats.screens}</div>
                        <div className="text-[10px] font-bold text-emerald-500 uppercase tracking-widest translate-y-[-2px]">{stats.onlineScreens} Online</div>
                    </div>
                </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-border bg-panel-bg shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all duration-500 p-5 h-28 flex flex-col justify-center">
                ...
                <div className="relative">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-[11px] font-black uppercase tracking-[0.2em] text-text-light/80">Empresas</span>
                    </div>
                    <div className="flex items-baseline gap-3">
                        <div className="text-3xl font-black text-text-dark">{stats.companies}</div>
                        <div className="text-[10px] font-bold text-text-light/60 uppercase tracking-widest translate-y-[-2px]">Clientes</div>
                    </div>
                </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-border bg-panel-bg shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all duration-500 p-5 h-28 flex flex-col justify-center">
                ...
                <div className="relative">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-[11px] font-black uppercase tracking-[0.2em] text-text-light/80">Armazenamento</span>
                    </div>
                    <div className="flex items-baseline gap-3">
                        <div className="text-3xl font-black text-text-dark">{storageGB}</div>
                        <div className="text-[10px] font-bold text-text-light/60 uppercase tracking-widest translate-y-[-2px]">GB ({storagePercent}%)</div>
                    </div>
                </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-border bg-panel-bg shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all duration-500 p-5 h-28 flex flex-col justify-center">
                ...
                <div className="relative">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-[11px] font-black uppercase tracking-[0.2em] text-text-light/80">Status</span>
                    </div>
                    <div className="flex flex-col">
                        <div className="text-xl font-black text-text-dark truncate leading-tight">{statusLabel}</div>
                        <div className="text-[10px] font-bold text-text-light/60 uppercase tracking-widest mt-0.5">{statusDetail}</div>
                    </div>
                </div>
            </div>
        </div>
