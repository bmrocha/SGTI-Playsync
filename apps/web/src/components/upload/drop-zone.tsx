            ...
            className={`
                ...
                ${isDragActive && !isDragReject
                    ...
                    : isDragReject
                        ...
                        : (!activeClassName && (variant === 'mini' ? 'p-4 flex items-center justify-center' : 'p-8') + ' border-border hover:border-brand-main/50 hover:bg-brand-main/5')
                }
            `}
        >
            <input {...getInputProps()} />
            ...
            {children ? (
                ...
                <div className={`flex flex-col items-center justify-center ${variant === 'mini' ? 'gap-1' : 'gap-3'} text-center h-full w-full`}>
                    {/* Icon */}
                    <div className={`
                    ...
                    `}>
                        {isDragReject ? (
                            ...
                            <Upload className={`${variant === 'mini' ? 'w-4 h-4' : 'w-6 h-6'} transition-colors ${isDragActive ? 'text-brand-main' : 'text-slate-400'
                                }`} />
                        )}
                    </div>
                        ...
                        {isDragReject ? (
                            ...
                            <>
                                <p className={cn(
                                    ...
                                    {variant === 'mini' ? 'Arraste ou clique' : 'Arraste arquivos ou clique para selecionar'}
                                </p>
                                {variant !== 'mini' && (
