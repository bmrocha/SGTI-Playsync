  ...
  return (
    <div className="space-y-6">
      ...
      <div className="pt-4 border-t border-slate-200 dark:border-white/10">
        <h3 className="text-xs font-bold uppercase text-slate-400 mb-3 ml-1 flex items-center gap-2">
          Templates Profissionais
          <span className="text-[9px] font-normal normal-case text-brand-main bg-brand-main/10 px-2 py-0.5 rounded-full">
            Premium
          </span>
        </h3>
