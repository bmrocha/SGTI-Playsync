...
export function LicenseGuard({ children }: { children: React.ReactNode }) {
  ...
  if (loading)
    return (
      <div className="min-h-screen bg-[#020a0a] flex items-center justify-center">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-sm">
                Ative o sistema com sua licença para liberar todas as funcionalidades.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-2">
              ...
              {user?.role === 'admin' ? (
                ...
                <p className="text-zinc-500 text-xs">
                  Apenas administradores podem configurar a chave pública.
                </p>
              )}
            </div>
