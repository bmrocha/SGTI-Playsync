...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    if (!hasPermission(currentUser.role as any, Permission.EDIT_COMPANY, currentUser.permissions)) {
...
export async function DELETE(
  ...
  try {
    ...
    if (
      !hasPermission(currentUser.role as any, Permission.DELETE_COMPANY, currentUser.permissions)
    ) {
