...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    if (
      !hasPermission(currentUser.role as any, Permission.EDIT_PLAYLIST, currentUser.permissions)
    ) {
...
export async function DELETE(
  ...
  try {
    ...
    if (
      !hasPermission(currentUser.role as any, Permission.DELETE_PLAYLIST, currentUser.permissions)
    ) {
